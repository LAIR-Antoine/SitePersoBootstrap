<?php
  ...
  if ($_SERVER["REQUEST_METHOD"] == "POST") # affiché les valeurs déjà saisies par l'utilisateur
  {
    ...
    {
      $array["firstnameError"] = "Moi c'est Antoine, et toi ?";
    ...
    {
      $array["emailError"] = "Malheureusement, ton email n'est pas valide !";
      $array["isSuccess"] = false;
    }
    else {
    ...
    {
      $array["messageError"] = "Tu dois bien avoir quelque chose à me dire si tu remplis ce formulaire de contact !";
      $array["isSuccess"] = false;
    }
    else {
